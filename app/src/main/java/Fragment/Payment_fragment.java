...
import btrade.payfort.Payforpayment;
import btrade.tcc.AppController;
import btrade.tcc.MainActivity;
import btrade.tcc.NetworkConnectivity.NetworkConnection;
import btrade.tcc.NetworkConnectivity.NetworkError;

import btrade.tcc.Paytm;
import btrade.tcc.R;
...
public class Payment_fragment extends Fragment {
    ...
    private void checked() {
        ...
        if (rb_card.isChecked()) {
            Intent myIntent = new Intent(getActivity(), Payforpayment.class);
            if (checkBox_Wallet.isChecked()) {
        ...
        if (rb_Netbanking.isChecked()) {
            Intent myIntent1 = new Intent(getActivity(), Payforpayment.class);
            if (checkBox_Wallet.isChecked()) {
