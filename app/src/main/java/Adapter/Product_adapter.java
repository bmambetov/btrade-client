...
import btrade.tcc.MainActivity;
import btrade.tcc.R;
...
public class Product_adapter extends RecyclerView.Adapter<Product_adapter.MyViewHolder> {
            ...
            if (id == R.id.iv_subcat_plus) {
                ...
                if (language.contains("english")) {
                    showProductDetail(modelList.get(position).getProduct_image(),
                            ...
                            modelList.get(position).getStore_name(),
                            "",
    ...
    public void onBindViewHolder(Product_adapter.MyViewHolder holder, int position) {
        ...
        Product_model product = modelList.get(position);
        if (Integer.valueOf(product.getIn_stock()) == 1) {
            holder.tv_add.setBackgroundResource(R.drawable.bg_rounded_button);
            holder.tv_add.setText(R.string.tv_pro_add);
            holder.tv_add.setEnabled(true);
            holder.iv_minus.setEnabled(true);
            holder.iv_plus.setEnabled(true);
        } else if (dbcart.isInCart(product.getProduct_id())){
            holder.tv_add.setText(R.string.tv_pro_update);
...
//        }
    ...
    private void showProductDetail(String image, String title, String description, String store_name, String detail, final int position, String qty) {
        ...
        TextView tv_detail2 = (TextView) dialog.findViewById(R.id.tv_product_detail2);
        ...
        Product_model product = modelList.get(position);
        if (Integer.valueOf(product.getIn_stock()) == 1) {
            tv_add.setBackgroundResource(R.drawable.bg_rounded_button);
            tv_add.setText(context.getResources().getString(R.string.tv_pro_add));
