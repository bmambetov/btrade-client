...
SharedPreferences preferences;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tv_pending_date, tv_pending_time, tv_confirm_date, textName, tv_confirm_time, tv_delevered_time, tv_cancel_time;
...
//            tv_cancel_time = (TextView) view.findViewById(R.id.cancel_time);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (mList.getItem_status().equals("0")) {
