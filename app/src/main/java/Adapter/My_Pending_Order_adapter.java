...
public class My_Pending_Order_adapter extends RecyclerView.Adapter<My_Pending_Order_adapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView textName, tv_orderno, tv_status, tv_date, tv_time, tv_price, tv_item, relativetextstatus, tv_tracking_date;
        public TextView tv_pending_date, tv_pending_time, tv_confirm_date, tv_confirm_time, tv_delevered_time, tv_cancel_time;
...
//            tv_cancel_time = (TextView) view.findViewById(R.id.cancel_time);
    ...
    @Override
    public void onBindViewHolder(@NonNull My_Pending_Order_adapter.MyViewHolder holder, int position) {
        My_Pending_order_model mList = modelList.get(position);

        holder.tv_orderno.setText(mList.getSale_id());
        String itemStatus = mList.getItem_status();
        if (itemStatus.equals("0")) {
            ...
            holder.tv_status.setText(context.getResources().getString(R.string.confirmed));
            holder.relativetextstatus.setText(context.getResources().getString(R.string.confirmed));
        ...
        holder.textName.setText((mList.getProduct_name() + " " + mList.getUser_name()));
